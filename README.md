...
## How to
1. Download the script according to your shell (Windows: [logcollector.ps1](logcollector.ps1/download), Bash on *nix: [logcollector.sh](logcollector.sh); Right-click -> save-as)
