...
- list of module(s) of this library used by your application (java-security, spring-security, spring-xsuaa etc...) and version of this library installed in your application.\
  *Alternative*: Output of maven dependency tree
- Stack trace that includes the executed code locations of this library that lead to the exception
- Auth service set-up of your application (XSUAA, IAS, XSUAA+IAS, IAS+AMS, etc.)
- Steps you have tried to fix the problem
- Reason that leads you to believe a bug in this library is causing your problem

Unfortunately, we can *NOT* offer consulting via support channels unless included in your contract with SAP.
