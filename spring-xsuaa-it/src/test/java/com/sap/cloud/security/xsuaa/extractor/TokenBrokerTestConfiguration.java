...
public class TokenBrokerTestConfiguration {
	...
	public OAuth2TokenService tokenBroker() {
		return new OAuth2TokenService() {
			...
			@Override
			public OAuth2TokenResponse retrieveAccessTokenViaX509(URI delegationEndpointUri, String clientId,
					String consumerCertificate, @Nullable String subdomain,
					@Nullable Map<String, String> optionalParameters) throws OAuth2ServiceException {
				return null;
			}
			...
			public OAuth2TokenResponse retrieveAccessTokenViaX509AndJwtBearerGrant(URI delegationEndpointUri,
					String clientId, String consumerCertificate, String oidcToken, @Nullable String subdomain,
					@Nullable Map<String, String> optionalParameters) throws OAuth2ServiceException {
				return null;
			}
