...
/**
 * IAS token and XSUAA token exchange class. Facilitates token exchange between IAS
 * and XSUAA
 */
public class IasXsuaaExchangeBroker {
     ...
     *
     * @param httpClient http client that will perform the request
     * @param token decoded IAS token
     * @param serviceConfiguration Xsuaa service configuration
