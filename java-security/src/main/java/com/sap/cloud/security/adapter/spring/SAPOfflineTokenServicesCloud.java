...
public class SAPOfflineTokenServicesCloud implements ResourceServerTokenServices, InitializingBean {
	 ...
	 *            environment.
	 * @deprecated In favor of {{@link #SAPOfflineTokenServicesCloud(OAuth2ServiceConfiguration, RestOperations)}} gets removed with the version 3.0.0, does not support certificate based authentication
	 */
	@Deprecated
