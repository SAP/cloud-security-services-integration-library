 ...
 * dynamically.
 */
@Deprecated // TODO delete: will be delivered with 2.8.4
public class HybridTokenFactory2 implements TokenFactory {

    private static final Logger LOGGER = LoggerFactory.getLogger(HybridTokenFactory2.class);
    ...
    static void withXsuaaAppId(@Nonnull String xsAppId) {
        ...
        HybridTokenFactory2.xsAppId = xsAppId;
