...
public class JwtGenerator {
    ...
    public static Jwt createFromTemplate(String pathToTemplate) throws Exception {
        String claims = IOUtils.toString(UserInfoTestUtil.class.getResourceAsStream(pathToTemplate),
    ...
    private static Jwt createFromClaims(String claims) throws Exception {
        String privateKey = IOUtils.toString(UserInfoTestUtil.class.getResourceAsStream("/privateKey.txt"),
                StandardCharsets.UTF_8); // PEM format
    ...
    public static Jwt convertTokenToOAuthJwt(String token) throws java.text.ParseException {
        ...
        Jwt jwt = new Jwt(parsedJwt.getParsedString(), jwtClaimsSet.getIssueTime().toInstant(),
