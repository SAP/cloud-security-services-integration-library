...
public class UserTokenFlowTests {
    ...
    public void test_constructor_withEndpointURIs() throws TokenFlowException {
        new UserTokenFlow(restTemplate, refreshTokenFlowMock, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
    }
    ...
    public void test_constructor_throwsOnNullValues() {
        ...
        assertThatThrownBy(() -> {
            new UserTokenFlow(null, refreshTokenFlowMock, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("RestTemplate");
        
        assertThatThrownBy(() -> {
            new UserTokenFlow(restTemplate, null, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("RefreshTokenFlow");
        
        assertThatThrownBy(() -> {
            new UserTokenFlow(restTemplate, refreshTokenFlowMock, null, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("Token endpoint");
        
        assertThatThrownBy(() -> {
            new UserTokenFlow(restTemplate, refreshTokenFlowMock, TestConstants.tokenEndpointUri, null, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("Authorize");
        
        assertThatThrownBy(() -> {
            new UserTokenFlow(restTemplate, refreshTokenFlowMock, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, null);
    ...
    public void test_execute_throwsIfMandatoryFieldsNotSet() {
        ...
        assertThatThrownBy(() -> {
            UserTokenFlow tokenFlow = new UserTokenFlow(restTemplate, refreshTokenFlowMock, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
            tokenFlow.execute();
    ...
    public void test_execute() throws TokenFlowException {
        ...
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedRequestURI, expectedRequest, Map.class, validMockJwt.getTokenValue(), HttpStatus.OK);
        
        UserTokenFlow tokenFlow = new UserTokenFlow(restTemplateMock, refreshTokenFlowMock, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        tokenFlow.token(validMockJwt)
                 .client(clientId)
                 .secret(clientSecret)
                 .execute();
    ...
    public void test_execute_throwsIfHttpStatusUnauthorized() throws TokenFlowException {
        ...
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedRequestURI, expectedRequest, Map.class, validMockJwt.getTokenValue(), HttpStatus.UNAUTHORIZED);
        ...
        assertThatThrownBy(() -> {
            ...
            .secret(clientSecret)
            .execute();
        }).isInstanceOf(TokenFlowException.class).hasMessageContaining(String.format("Received status code %s", HttpStatus.UNAUTHORIZED));
    }
    ...
    public void test_execute_throwsIfHttpStatusIsNotOK() {
        ...
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedRequestURI, expectedRequest, Map.class, validMockJwt.getTokenValue(), HttpStatus.CONFLICT);
        ...
        assertThatThrownBy(() -> {
            ...
            .secret(clientSecret)
            .execute();
        }).isInstanceOf(TokenFlowException.class).hasMessageContaining(String.format("Received status code %s", HttpStatus.CONFLICT));
    }
    ...
    public void test_execute_withAdditionalAuthorities() throws TokenFlowException, JsonProcessingException {
        ...
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedURI, expectedRequest, Map.class, validMockJwt.getTokenValue(), HttpStatus.OK);
