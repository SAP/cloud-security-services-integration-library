...
public class XsuaaAudienceValidatorTest {
    ...
    public void testSameClientId() {
        OAuth2TokenValidatorResult result = new XsuaaAudienceValidator(
                new DummyXsuaaServiceConfiguration("sb-test1!t1", "test1!t1")).validate(tokenWithAudience);
        Assert.assertFalse(result.hasErrors());
    }

    @Test
    public void testSameClientIdWithoutAudience() {
        OAuth2TokenValidatorResult result2 = new XsuaaAudienceValidator(
                new DummyXsuaaServiceConfiguration("sb-test1!t1", "test1!t1")).validate(tokenWithoutAudience);
    ...
    public void testOtherGrantedClientId() {
        OAuth2TokenValidatorResult result = new XsuaaAudienceValidator(
                new DummyXsuaaServiceConfiguration("sb-test2!t1", "test2!t1")).validate(tokenWithAudience);
        Assert.assertFalse(result.hasErrors());
    }
    ...
    public void testOtherGrantedClientIdWithoutAudience() {
        OAuth2TokenValidatorResult result = new XsuaaAudienceValidator(
                new DummyXsuaaServiceConfiguration("sb-test2!t1", "test2!t1")).validate(tokenWithoutAudience);
        Assert.assertFalse(result.hasErrors());
    }
    ...
    public void testUnGrantedClientId() {
        OAuth2TokenValidatorResult result = new XsuaaAudienceValidator(
                new DummyXsuaaServiceConfiguration("sb-test3!t1", "test3!t1")).validate(tokenWithAudience);
