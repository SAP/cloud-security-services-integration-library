...
public class ClientCredentialsTokenFlowTests {
    ...
    public void test_constructor_withEndpointURIs() throws TokenFlowException {
        new ClientCredentialsTokenFlow(restTemplate, tokenDecoder, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
    }
    ...
    public void test_constructor_throwsOnNullValues() {
        ...
        assertThatThrownBy(() -> {
            new ClientCredentialsTokenFlow(null, tokenDecoder, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("RestTemplate");
        
        assertThatThrownBy(() -> {
            new ClientCredentialsTokenFlow(restTemplate, null, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("TokenDecoder");
        
        assertThatThrownBy(() -> {
            new ClientCredentialsTokenFlow(restTemplate, tokenDecoder, null, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("Token");
        
        assertThatThrownBy(() -> {
            new ClientCredentialsTokenFlow(restTemplate, tokenDecoder, TestConstants.tokenEndpointUri, null, TestConstants.keySetEndpointUri);
        }).isInstanceOf(IllegalArgumentException.class).hasMessageStartingWith("Authorize");
        
        assertThatThrownBy(() -> {
            new ClientCredentialsTokenFlow(restTemplate, tokenDecoder, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, null);
    ...
    public void test_execute() throws TokenFlowException {
        ...
        URI expectedURI = UriComponentsBuilder.fromUri(TestConstants.tokenEndpointUri).queryParam("grant_type", "client_credentials").build().toUri(); 
        
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedURI, expectedRequest, Map.class, mockJwt.getTokenValue(), HttpStatus.OK);
        
        ClientCredentialsTokenFlow tokenFlow = new ClientCredentialsTokenFlow(restTemplateMock, tokenDecoderMock, TestConstants.tokenEndpointUri, TestConstants.authorizeEndpointUri, TestConstants.keySetEndpointUri);
    ...
    public void test_execute_throwsIfHttpStatusUnauthorized() {
        ...
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedURI, expectedRequest, Map.class, mockJwt.getTokenValue(), HttpStatus.UNAUTHORIZED);
    ...
    public void test_execute_throwsIfHttpStatusIsNotOK() {
        ...
        RestTemplateMock restTemplateMock = new RestTemplateMock(expectedURI, expectedRequest, Map.class, mockJwt.getTokenValue(), HttpStatus.CONFLICT);
