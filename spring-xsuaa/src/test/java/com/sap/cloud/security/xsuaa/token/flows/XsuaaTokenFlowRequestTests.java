...
public class XsuaaTokenFlowRequestTests {
    ...
    public void test_constructor() {
        new XsuaaTokenFlowRequest(URI.create("http://token/"), URI.create("http://authz/"), URI.create("http://token_keys/"));
    }
    ...
    public void test_getters() {
        ...
        XsuaaTokenFlowRequest request = new XsuaaTokenFlowRequest(tokenEndpointUri, authorizationEndpointUri, tokenKeysUri);
        request.setClientId(clientId);
        request.setClientSecret(clientSecret);
        
        assertEquals("TokenEndpointURI does not match.", request.getTokenEndpoint(), tokenEndpointUri);
        assertEquals("AuthorizationEndpointURI does not match.", request.getAuthorizeEndpoint(), authorizationEndpointUri);
