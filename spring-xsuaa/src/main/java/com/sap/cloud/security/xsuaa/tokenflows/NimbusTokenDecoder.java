...
public class NimbusTokenDecoder implements VariableKeySetUriTokenDecoder {
    ...
    /* (non-Javadoc)
     * @see com.sap.cloud.address.service.xsuaa.tokenflows.TokenDecoder#setJwksURI(java.net.URI)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.sap.cloud.address.service.xsuaa.tokenflows.TokenDecoder#decode(java.lang.String)
     */
    @Override
