...
public final class TokenClaims {
	 ...
	 *  and if the user actually has a user UUID. This is true if the user physically exists in the IAS user store
	 *  and IAS is not a pure proxy which simply forwards all information from the corporate IdP.
	 */
