...
class XsuaaTokenFlowsUtils {
    ...
    /**
     * Adds the {@code  Authorization: Basic <credentials>} header to the set of headers.
     * @param headers - the set of headers to add the header to.
    ...
    static String buildAuthorities(XsuaaTokenFlowRequest request) throws TokenFlowException {
        ...
        try {
            ...
            throw new TokenFlowException("Error mapping additional authorization attributes to JSON. See root cause exception. ", e);
        }
    }

    static String buildAdditionalAuthoritiesJson(Map<String, String> additionalAuthorities) throws JsonProcessingException {
