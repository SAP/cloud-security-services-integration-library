 ...
 * 
 * For using this feature also in multi tenancy mode request-parameter {@code X-Identity-Zone-Subdomain} must be set or
 * the AuthenticationInformationExtractor needs to be implemented).
 *
 */
