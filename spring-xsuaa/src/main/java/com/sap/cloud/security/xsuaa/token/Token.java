...
public interface Token extends UserDetails {
    ...
    /**
     * User name used for authentication, e.g. an email address or other identifier. A user might exist in multiple
     * identity providers. The following information is required to to uniquely identify a user: - username: name of the
     * user in an identity provider - origin: alias to an identity provider - subaccount id: identifier for the
     * subaccount
     *
     * @return user name
     */
    ...
    /**
     * Return the user origin. The origin is an alias that refers to a user store in which the user is persisted. For
