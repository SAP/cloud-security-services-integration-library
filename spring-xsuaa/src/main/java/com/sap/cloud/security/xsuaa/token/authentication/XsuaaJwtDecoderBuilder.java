...
public class XsuaaJwtDecoderBuilder {
    ...
    /**
     * Decoders cache the signing keys. Set the cache time. Default: 900 seconds
     * 
     * @param timeInSeconds
     * @return
     */
    ...
    /**
     * Determine size of cached decoder. Mainly relevant for multi tenant applications. Default:100
     * 
     * @param size
     * @return
     */
