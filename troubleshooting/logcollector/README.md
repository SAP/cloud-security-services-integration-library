...
## How to use
1. Download (Right-click -> save-link-as) the script according to your shell (Windows: [cf-logcollector.ps1](cf-logcollector.ps1), Bash on *nix: [cf-logcollector.sh](cf-logcollector.sh))
