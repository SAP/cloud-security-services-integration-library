...
public interface XSUserInfo {
     ...
     * identity providers. The following information is required to to uniquely identify a user: - -
     * 
     * 
    ...
    /**
     * Return additional authentication attributes included by the OAuth client component. Note: this is data controlled
