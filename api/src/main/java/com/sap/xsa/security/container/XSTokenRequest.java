...
public interface XSTokenRequest {
     ...
     * 
     * @param clientId
     *            a string, no more than 255 characters identifying a valid client on the UAA
    ...
    /**
     * Returns the list of requested additional authorization attributes, or null if no additional authorization
     * attributes have been requested.
     * 
     * @return the list of requested additional authorization attributes, or null if no additional authorization
     *         attributes have been requested.
     */
    public Map<String, String> getAdditionalAuthorizationAttributes();

    /**
     * Sets the requested additional authorization attributes list for this token request. Use this if you would like to
     * add additional authorization attributes to the access token
     * 
     * @param additionalAuthorizationAttributes
     *            a set of strings representing requested additional authorization attributes
     * @return this mutable object
     */
     ...
     * 
     * @param type
     *            type of token request: TYPE_USER_TOKEN or TYPE_CLIENT_CREDENTIAL_TOKEN
     * @return this mutable object
     */
