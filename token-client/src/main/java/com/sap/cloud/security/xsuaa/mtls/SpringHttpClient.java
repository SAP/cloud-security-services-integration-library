...
/**
 * SpringHttpClient provides factory methods to initialize RestTemplate for certificate(HTTPS) based and client secret(HTTP) based communications.
 */
public class SpringHttpClient {
    ...
    /**
     * Creates a HTTPS RestTemplate. Used to setup HTTPS client for X.509 certificate based communication.
     * Derives certificate and private key values from ClientIdentity.
     *
     * @param clientIdentity ClientIdentity of Xsuaa Service
     * @return RestTemplate instance
     * @throws ServiceClientException if ClientIdentity wasn't certificate based
     */
