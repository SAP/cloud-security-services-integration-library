...
/**
 * Configuration interface for the Token Client.
 * Defines methods for configuring retry behavior and other settings related to token retrieval.
 */
