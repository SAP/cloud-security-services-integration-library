 ...
 * than by reference where applicable.
 */
public class AbstractOAuth2TokenServiceTest {
  ...
  public static final TokenCacheConfiguration TEST_CACHE_CONFIGURATION =
  ...
  @Test
  public void retrieveAccessTokenViaClientCredentials_activeCache_responseNotNull()
  ...
  @Test
  public void retrieveAccessTokenViaClientCredentials_noCache_responseNotNull()
      throws OAuth2ServiceException {
  ...
  public void retrieveAccessTokenViaClientCredentials_forDifferentZoneIds_TwoRequestCalls()
    ...
    cut.retrieveAccessTokenViaClientCredentialsGrant(
        TOKEN_ENDPOINT_URI, clientIdentity(), "ZONE-ID", SUBDOMAIN, null, false);
    cut.retrieveAccessTokenViaClientCredentialsGrant(
        TOKEN_ENDPOINT_URI, clientIdentity(), "ZONE-ID", SUBDOMAIN, null, false);
    cut.retrieveAccessTokenViaClientCredentialsGrant(
        TOKEN_ENDPOINT_URI, clientIdentity(), "OTHER_ZONE-ID", SUBDOMAIN, null, false);
  ...
  @Test
  public void requestAccessToken_differentTokenEndpoint_requestsFreshToken()
      throws OAuth2ServiceException {
  ...
  @Test
  public void requestAccessToken_differentSubdomain_requestsFreshToken()
      throws OAuth2ServiceException {
  ...
  @Test
  public void requestAccessToken_differentAdditionalParameters_requestsFreshToken()
      throws OAuth2ServiceException {
  ...
  @Test
  public void requestAccessToken_sameAdditionalParameters_onlyOneRequestCall()
      throws OAuth2ServiceException {
  ...
  @Test
  public void requestAccessToken_cacheGloballyDisabled_requestsFreshTokens()
      throws OAuth2ServiceException {
    cut = new TestOAuth2TokenService(TokenCacheConfiguration.cacheDisabled());
  ...
  @Test
  public void requestAccessToken_cachedTokens_structurallyEqual() throws OAuth2ServiceException {
    OAuth2TokenResponse firstResponse = retrieveAccessTokenViaClientCredentials();
    OAuth2TokenResponse secondResponse = retrieveAccessTokenViaClientCredentials();

    // With the SecurityCache SPI cached tokens travel through JSON — different instance, same state.
    assertThat(firstResponse).isNotSameAs(secondResponse);
    assertThat(secondResponse.getAccessToken()).isEqualTo(firstResponse.getAccessToken());
    assertThat(secondResponse.getExpiredAt()).isEqualTo(firstResponse.getExpiredAt());
    assertThat(cut.tokenRequestCallCount).isEqualTo(1);
  }

  @Test
  public void requestAccessToken_tokensAreInvalidatedAfterTime_requestsFreshToken()
      throws OAuth2ServiceException {
    retrieveAccessTokenViaClientCredentials();
  ...
  @Test
  public void requestAccessToken_cacheDisabledForRequest_requestsFreshTokens()
      throws OAuth2ServiceException {
    retrieveAccessTokenViaClientCredentials(clientIdentity(), false);
    retrieveAccessTokenViaClientCredentials(clientIdentity(), true);
    retrieveAccessTokenViaClientCredentials(clientIdentity(), false);
  ...
  @Test
  public void requestAccessToken_timeAdvancedAndGotExpired_requestsFreshToken()
      throws OAuth2ServiceException {
    cut = new TestOAuth2TokenService(cacheConfigurationWithDelta(Duration.ofSeconds(10)));
    cut.setExpiredAt(NOW.plus(Duration.ofSeconds(30)));
  ...
  private OAuth2TokenResponse retrieveAccessTokenViaJwtBearerTokenGrant(
      String token, Map<String, String> optionalParameters) throws OAuth2ServiceException {
    return cut.retrieveAccessTokenViaJwtBearerTokenGrant(
        TOKEN_ENDPOINT_URI, clientIdentity(), token, null, optionalParameters, false);
  }

  private OAuth2TokenResponse retrieveAccessTokenViaClientCredentials()
      throws OAuth2ServiceException {
    return retrieveAccessTokenViaClientCredentials(clientIdentity(), false);
  }

  private OAuth2TokenResponse retrieveAccessTokenViaClientCredentials(
      ClientIdentity clientIdentity, boolean disableCacheForRequest)
      throws OAuth2ServiceException {
    return cut.retrieveAccessTokenViaClientCredentialsGrant(
        TOKEN_ENDPOINT_URI, clientIdentity, ZONE_ID, SUBDOMAIN, null, disableCacheForRequest);
  }

  private OAuth2TokenResponse retrieveAccessTokenViaPasswordGrant(String username)
      throws OAuth2ServiceException {
    return cut.retrieveAccessTokenViaPasswordGrant(
        TOKEN_ENDPOINT_URI, clientIdentity(), username, "password", SUBDOMAIN, null, false);
  }

  private OAuth2TokenResponse retrieveAccessTokenViaPasswordGrant(URI tokenEndpointUri)
      throws OAuth2ServiceException {
    return cut.retrieveAccessTokenViaPasswordGrant(
        tokenEndpointUri, clientIdentity(), "username", "password", SUBDOMAIN, null, false);
  }

  private OAuth2TokenResponse retrieveAccessTokenViaRefreshToken(String refreshToken)
      throws OAuth2ServiceException {
    return retrieveAccessTokenViaRefreshToken(refreshToken, SUBDOMAIN);
  }

  private OAuth2TokenResponse retrieveAccessTokenViaRefreshToken(
      String refreshToken, String subdomain) throws OAuth2ServiceException {
    return cut.retrieveAccessTokenViaRefreshToken(
        TOKEN_ENDPOINT_URI, clientIdentity(), refreshToken, subdomain, false);
  }
  ...
  private TokenCacheConfiguration cacheConfigurationWithDelta(Duration delta) {
    return TokenCacheConfiguration.getInstance(
        TEST_CACHE_CONFIGURATION.getCacheDuration(),
        TEST_CACHE_CONFIGURATION.getCacheSize(),
        delta);
  }
  ...
  private TokenCacheConfiguration cacheConfigurationWithCacheStatistics(
      boolean enableCacheStatistics) {
    return TokenCacheConfiguration.getInstance(
        TEST_CACHE_CONFIGURATION.getCacheDuration(),
        TEST_CACHE_CONFIGURATION.getCacheSize(),
        TEST_CACHE_CONFIGURATION.getTokenExpirationDelta(),
  ...
  static class TestOAuth2TokenService extends AbstractOAuth2TokenService {

    private static final TestCacheTicker testCacheTicker = new TestCacheTicker();
    int tokenRequestCallCount = 0;
    ...
    protected OAuth2TokenResponse requestAccessToken(
      ...
      // Absolute-expiry constructor to align with the mocked expiredAt.
      return new OAuth2TokenResponse("token", null, "bearer", expiredAt.toEpochMilli());
    }
  }
