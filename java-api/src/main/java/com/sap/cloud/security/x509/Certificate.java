...
public interface Certificate {
	...
	/**
	 * Gets certificate 'x5t' thumbprint which is a base64url-encoded SHA-1 thumbprint (a.k.a. digest) of the DER
	 * encoding of an X.509 certificate.
	 *
	 * @return the thumbprint
	 * @throws InvalidCertificateException
	 * 		if error occurs while encoding X509 certificate or when a particular cryptographic algorithm is not supported
	 * @see <a href= "https://datatracker.ietf.org/doc/html/rfc7517#section-4.8">x5t</a>
	 */
