...
public class SecurityTest {
     ...
     * server is not yet initialized as part of {@link #setup()} method. You can find
     ...
     * Otherwise it resets WireMock and configures the stubs.
     * Additionally it generates the JWK URL.
     * Should be called before each test. Starts the server only, if it was not yet started.
     *
     * @throws IOException
    ...
    /**
     * Shuts down Jetty application web server and WireMock stub. Should be called when all tests are executed
