...
/**
 * LocalhostIssuerValidator brings backward-compatibility for test credentials
 ...
 * domain without port in the service credentials. This class MUST NOT be loaded
 * outside test scope and MUST be the ONLY implementation of
 * {@link TestIssuerValidator}.
 */
