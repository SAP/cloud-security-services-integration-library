...
git push sec-lib-spring master_version
echo "Next Steps:"
echo "1. Update version in samples Version to $pomVersion"
echo "2. git push sec-lib-spring master_version"
echo "3. start PR from master_version"
