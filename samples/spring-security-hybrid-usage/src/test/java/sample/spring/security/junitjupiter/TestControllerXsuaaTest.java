...
class TestControllerXsuaaTest {
	...
	/**
	 * Ensures that tokens with a JKU whose domain differs from the {@link com.sap.cloud.security.config.cf.CFConstants.XSUAA#UAA_DOMAIN} in the credentials are still not trusted,
