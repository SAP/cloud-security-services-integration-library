...
/**
 * PoJo of Spring configuration properties.
 * It implements the {@link OAuth2ServiceConfiguration} and enhances it with
 * <ul>
 *   <li>setters</li>
 *   <li>Xsuaa specific setters to map Xsuaa specific configuration such as {@code uaadomain}, {@code xsappname}</li>
 * </ul>
 * You can define your own prefix when declaring {@code @ConfigurationProperties("xsuaa")}.
 * This then needs to be mapped to {@code $vcap.services.<your service instance name>.credentials}
 * as part of your application properties. <br>
 *
 * Alternatively, its possible to directly map the properties to {@code VCAP_SERVICES}
...
public class OAuth2ServiceConfigurationProperties implements OAuth2ServiceConfiguration {
     ...
     *
     * @param xsAppName the xsappname as specified in the {@code xs-security.json}.
     */
     ...
     *
     * @param verificationKey the verification key that provides the public key of the
     *                        private key the token is signed with.
     */
